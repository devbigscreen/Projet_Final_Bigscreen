    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'answer_id' => '50',
                'user_id' => 'test3',
                'answers' => 'regarder la TV en direct'
            ],
        ...
        foreach ($data as $userAnswersData) {
            UserAnswers::create([
                ...
                'answer_id' => $userAnswersData['answer_id'],
                'user_id' => $userAnswersData['user_id'],
                'answers' => $userAnswersData['answers'] ?? null,
            ]);
        }
    }
}
